...
$mancc = $_GET['chon'];
 ...
 ?>
<h3 style="text-align: center;">Sản phẩm của nhà cung cấp <?php echo $mancc ?></h3>
...
require('../chucnang/condb.php');
	...
	$sql = "SELECT * FROM sanpham WHERE nhacungcap = '$mancc' LIMIT $begin,4";
...
<div class="hienthisanpham">
		...
		<div class="sanpham">
			...
			<div class="hinhanh"><a href="index.php?menuadmin=chitietsanpham&code=<?php echo $row['masp'] ?>"><img src="../images/sanpham1/<?php echo $row['hinhanh']; ?>"></a></div>
			<!-- <div class="xemsanpham">XEM NGAY</div> -->
			
		</div>
		<div class="tensp"><a href="index.php?menuadmin=chitietsanpham&code=<?php echo $row['masp'] ?>"><?php echo $row['tensanpham']; ?></a></div>
		...
		<div class="chucnangmua">
			<div class="muangay"><a href="index.php?menuadmin=chitietsanpham&code=<?php echo $row['masp'] ?>"><i class='fa fa-shopping-bag fa-5x' style='color:#000000'></i></a></div>
