...
if ($_POST['timkiem']) {
	...
	?>
	<div class="hienthisanpham1">
	
		<div class="sanpham">

			<div class="hinhanhtimkiem"><a href="index.php?menupage=chitietsanpham&code=<?php echo $row['masp'] ?>"><img src="../images/sanpham1/<?php echo $row['hinhanh']; ?>"></a></div>
